...
<main>
    ...
    <h3 class="display-4 m-2 text-center mt-4">Scheduled Requests</h3>
        ...
        <table id="enquiries" class="table table-hover table-responsive dt-responsive" style="width:100%;">
            <thead>
                <tr>
                    ...
                    <th scope="col">Preferred Time for customer</th>                    
            ...
            <tbody>
                ...
                $sql = "SELECT * from enquiry_walater ORDER BY EnquiryTimeStamp DESC";
                ...
                <tr>
                    ...
                    <td><?php echo $enquiry['CustomerPrefTime']; ?></td>
                    <td><a href="../gallery.php#<?php echo $enquiry['ProductId']; ?>"><?php echo $enquiry['ProductId']; ?></a></td>
                    <td><?php echo date('G:ia | jS M \'y', strtotime($enquiry['EnquiryTimeStamp'])); ?></td>
                    <td><?php if($enquiry['CustomerMessage']!=null) echo $enquiry['CustomerMessage']; else echo '<p class="text-secondary">NA</p>'?></td>
                    <td>
                        <?php echo
                        '<form method="post" action="del_enquiry.php">
                            <input type="hidden" name="enquiry_id" value="'.$enquiry['EnquiryId'].'">
                            <input type="hidden" name="enquiry_type" value="later">
